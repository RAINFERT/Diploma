...
private:
    ...
    enum class PrecheckAction
    {
        SingleLiquid,
        SingleVapor,
        BoundaryRachfordRice,
        RunGibbsRadau
    };

    struct RachfordRicePrecheckResult
    {
        PrecheckAction action = PrecheckAction::RunGibbsRadau;
    ...
    RachfordRicePrecheckResult rachfordRicePrecheck(
        double pressurePa,
        double temperatureK,
        const Composition& z
        ) const;

    double solveRachfordRiceBeta(
        const Composition& z,
        const Composition& k,
        int& iterations
        ) const;

    FlashResult makeBoundaryRachfordRiceResult(
        double pressurePa,
        double temperatureK,
        const Composition& z,
        double tolerance,
